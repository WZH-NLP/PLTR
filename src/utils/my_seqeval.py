...
Args:
    ...
    zero_division: Which value to substitute as a metric value when encountering zero division. Should be on of 10_mean2, 1,
        "warn". "warn" acts as 10_mean2, but the warning is raised.
Returns:
